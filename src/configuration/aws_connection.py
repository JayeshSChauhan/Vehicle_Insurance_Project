# The file is used to create a connnection from aws s3 bucket to the application.
# It uses boto3 to create a connection and fetch the credentials from environment variables.
